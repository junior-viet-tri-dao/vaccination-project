...
@AllArgsConstructor
@Builder
public class UpdateTransactionSupplierRequest {

    // ID hóa đơn (bắt buộc để xác định record cần update)
    @NotBlank(message = "ID hóa đơn không được để trống")
    ...
    // Mã hóa đơn (bắt buộc, tối đa 10 ký tự)
    ...
    // Tên nhà cung cấp (bắt buộc, tối đa 20 ký tự)
